 ...
 * Project :      HR Database
 *
 * Date Created : Friday, May 09, 2025 15:30:47
 * Target DBMS : Microsoft SQL Server 2017
 */

CREATE TYPE "Global Timestamp" FROM timestamp NULL
go
...
CREATE TABLE CNR(
    ...
    PRIMARY KEY NONCLUSTERED (EMP_NMB)
)
...
CREATE TABLE EMP(
    ...
    ADR_ID             char(10)          NOT NULL,
    [Promotion Flag]   char(5)           NULL,
    POMOTION_REASON    char(10)          NULL,
    PRIMARY KEY NONCLUSTERED (EMP_NMB)
)
...
CREATE TABLE EMP_SKL_MTX(
    ...
    EMP_NMB    char(10)    NOT NULL,
    LVL        char(10)    NULL,
    PRIMARY KEY NONCLUSTERED (ID, EMP_NMB)
)
...
CREATE TABLE [SKL TRG_CRS](
    ...
    PRIMARY KEY NONCLUSTERED (ID, CRS_ID)
)
...
CREATE TABLE TRG_CRS(
    ...
    PRIMARY KEY NONCLUSTERED (CRS_ID)
)
...
CREATE TABLE TRG_HST(
    ...
    RESULT            char(10)       NULL,
    PRIMARY KEY NONCLUSTERED (EMP_NMB, CRS_ID, EMPNMB)
)
...
,@level1type = N'Table', @level1name = 'ADR'
