 ...
 * Company :      IDERA
 * Project :      Adventure Work.DM1
 * Author :       Product Management
 *
 * Date Created : Friday, March 14, 2025 09:29:23
...
ALTER TABLE ContactCreditCard ADD CONSTRAINT FK_ContactCreditCard_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go

ALTER TABLE ContactCreditCard ADD CONSTRAINT FK_ContactCreditCard_CreditCard_CreditCardID 
...
ALTER TABLE CustomerAddress ADD CONSTRAINT FK_CustomerAddress_AddressType_AddressTypeID 
...
ALTER TABLE Employee ADD CONSTRAINT FK_Employee_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go

ALTER TABLE Employee ADD CONSTRAINT FK_Employee_Employee_ManagerID 
...
ALTER TABLE EmployeeAddress ADD CONSTRAINT FK_EmployeeAddress_Address_AddressID 
    FOREIGN KEY (AddressID)
    REFERENCES Address(AddressID)
go

ALTER TABLE EmployeeAddress ADD CONSTRAINT FK_EmployeeAddress_Employee_EmployeeID 
...
ALTER TABLE EmployeeDepartmentHistory ADD CONSTRAINT FK_EmployeeDepartmentHistory_Employee_EmployeeID 
    FOREIGN KEY (EmployeeID)
    REFERENCES Employee(EmployeeID)
go
...
ALTER TABLE EmployeePayHistory ADD CONSTRAINT FK_EmployeePayHistory_Employee_EmployeeID 
    FOREIGN KEY (EmployeeID)
    REFERENCES Employee(EmployeeID)
go
...
ALTER TABLE Individual ADD CONSTRAINT FK_Individual_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go

ALTER TABLE Individual ADD CONSTRAINT FK_Individual_Customer_CustomerID 
    FOREIGN KEY (CustomerID)
    REFERENCES Customer(CustomerID)
go
...
ALTER TABLE JobCandidate ADD CONSTRAINT FK_JobCandidate_Employee_EmployeeID 
    FOREIGN KEY (EmployeeID)
    REFERENCES Employee(EmployeeID)
go
...
ALTER TABLE ProductDocument ADD CONSTRAINT FK_ProductDocument_Document_DocumentID 
...
ALTER TABLE ProductVendor ADD CONSTRAINT FK_ProductVendor_Vendor_VendorID 
...
ALTER TABLE SalesOrderHeader ADD CONSTRAINT FK_SalesOrderHeader_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go
...
ALTER TABLE SalesPerson ADD CONSTRAINT FK_SalesPerson_Employee_SalesPersonID 
    FOREIGN KEY (SalesPersonID)
    REFERENCES Employee(EmployeeID)
go
...
ALTER TABLE SalesPersonQuotaHistory ADD CONSTRAINT FK_SalesPersonQuotaHistory_SalesPerson_SalesPersonID 
    FOREIGN KEY (SalesPersonID)
    REFERENCES SalesPerson(SalesPersonID)
go
...
ALTER TABLE SalesTerritoryHistory ADD CONSTRAINT FK_SalesTerritoryHistory_SalesPerson_SalesPersonID 
    FOREIGN KEY (SalesPersonID)
    REFERENCES SalesPerson(SalesPersonID)
go
...
ALTER TABLE Store ADD CONSTRAINT FK_Store_Customer_CustomerID 
    FOREIGN KEY (CustomerID)
    REFERENCES Customer(CustomerID)
go
...
ALTER TABLE StoreContact ADD CONSTRAINT FK_StoreContact_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go

ALTER TABLE StoreContact ADD CONSTRAINT FK_StoreContact_ContactType_ContactTypeID 
    FOREIGN KEY (ContactTypeID)
    REFERENCES ContactType(ContactTypeID)
go

ALTER TABLE StoreContact ADD CONSTRAINT FK_StoreContact_Store_CustomerID 
    FOREIGN KEY (CustomerID)
...
ALTER TABLE VendorAddress ADD CONSTRAINT FK_VendorAddress_Address_AddressID 
    FOREIGN KEY (AddressID)
    REFERENCES Address(AddressID)
go

ALTER TABLE VendorAddress ADD CONSTRAINT FK_VendorAddress_AddressType_AddressTypeID 
    FOREIGN KEY (AddressTypeID)
    REFERENCES AddressType(AddressTypeID)
go

ALTER TABLE VendorAddress ADD CONSTRAINT FK_VendorAddress_Vendor_VendorID 
    FOREIGN KEY (VendorID)
    REFERENCES Vendor(VendorID)
go
...
ALTER TABLE VendorContact ADD CONSTRAINT FK_VendorContact_Contact_ContactID 
    FOREIGN KEY (ContactID)
    REFERENCES Contact(ContactID)
go

ALTER TABLE VendorContact ADD CONSTRAINT FK_VendorContact_ContactType_ContactTypeID 
    FOREIGN KEY (ContactTypeID)
    REFERENCES ContactType(ContactTypeID)
go

ALTER TABLE VendorContact ADD CONSTRAINT FK_VendorContact_Vendor_VendorID 
    FOREIGN KEY (VendorID)
    REFERENCES Vendor(VendorID)
go
